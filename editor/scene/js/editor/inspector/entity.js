...
Object.assign(pcui, (function () {
    ...
    const TAGS_OPTIONS = [
        {v:'flex' , t:'flex'},
        {v:'flex-row'  , t:'flex-row'},
        
        {v:'flex-col' , t: 'flex-col' },
        
        {v:'flex-columns'  , t:'flex-columns'},
        
        {v:'flex-first'  , t:'flex-first'},
        
        {v:'flex-x-center' , t:'flex-x-center'},
        
        {v:'flex-center'  , t:'flex-center'},
        {v:'flex-last'  , t:'flex-last' },
        
        {v:'flex-items-top' , t: 'flex-items-top'},
        
        {v:'flex-items-middle' , t:'flex-items-middle'},
        
        {v:'flex-items-bottom' , t:'flex-items-bottom' },
        {v:'flex-top' , t:'flex-top'},
        
        {v:'flex-middle'  , t:'flex-middle'},
        
        {v:'flex-bottom'  , t:'flex-bottom'},
        
        {v:'flex-items-left'  , t:'flex-items-left'},
        
        {v:'flex-items-center'  , t:'flex-items-center'},
        
        {v:'flex-items-right' , t:'flex-items-right'},
        
        {v:'flex-items-around' , t:'flex-items-around'},
        
        {v:'flex-items-between' , t:'flex-items-between'}
    ];
    const ATTRIBUTES = [{
        label: 'Enabled',
        path: 'enabled',
