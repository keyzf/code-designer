...
editor.once('load', function() {
    ...
    menu.on('open', function() {
        ...
        if (currentAsset) {
            // download
            menuItemDownload.hidden = ! ((! config.project.privateAssets || (config.project.privateAssets && editor.call('permissions:read'))) && currentAsset.get('type') !== 'folder' && (currentAsset.get('source') || downloadable[currentAsset.get('type')] || (currentAsset.get('type') === 'script')) && currentAsset.get('file.url'));
