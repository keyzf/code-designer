Object.assign(pc2d, function () {
    ...
    /**
     * @class
     * @name pc2d.AnimationComponentSystem
     * @augments pc2d.ComponentSystem
     ...
     * @param {pc2d.Application} app - The application managing this system.
     */
    var AnimationComponentSystem = function AnimationComponentSystem(app) {
        ...
        this.ComponentType = pc2d.AnimationComponent;
        this.DataType = pc2d.AnimationComponentData;
    ...
    AnimationComponentSystem.prototype = Object.create(pc2d.ComponentSystem.prototype);
    AnimationComponentSystem.prototype.constructor = AnimationComponentSystem;

    pc2d.Component._buildAccessors(pc2d.AnimationComponent.prototype, _schema);
