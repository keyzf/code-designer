Object.assign(pc2d, (function () {
    ...
    Object.assign(Quat.prototype, {
        /**
         * @function
         * @name pc2d.Quat#clone
         * @description Returns an identical copy of the specified quaternion.
         * @returns {pc2d.Quat} A quaternion containing the result of the cloning.
         * @example
         * var q = new pc2d.Quat(-0.11, -0.15, -0.46, 0.87);
         * var qclone = q.clone();
         *
         * console.log("The result of the cloning is: " + q.toString());
         */
        clone: function () {
            return new pc2d.Quat(this.x, this.y, this.z, this.w);
        },
         ...
         * @param {pc2d.Quat} rhs - The quaternion to be copied.
         * @returns {pc2d.Quat} Self for chaining.
         * @example
         * var src = new pc2d.Quat();
         * var dst = new pc2d.Quat();
         * dst.copy(src, src);
        ...
        /**
         * @function
         * @name pc2d.Quat#equals
         * @description Reports whether two quaternions are equal.
         * @param {pc2d.Quat} rhs - The quaternion to be compared against.
         ...
         * @param {pc2d.Vec3} axis - The 3-dimensional vector to receive the axis of rotation.
         * @returns {number} Angle, in degrees, of the rotation.
         * @example
         * var q = new pc2d.Quat();
         * q.setFromAxisAngle(new pc2d.Vec3(0, 1, 0), 90);
         * var v = new pc2d.Vec3();
        ...
        getAxisAngle: function (axis) {
            ...
            return rad * pc2d.math.RAD_TO_DEG;
        },

        /**
         * @function
         * @name pc2d.Quat#getEulerAngles
         * @description Converts the supplied quaternion to Euler angles.
         * @param {pc2d.Vec3} [eulers] - The 3-dimensional vector to receive the Euler angles.
         * @returns {pc2d.Vec3} The 3-dimensional vector holding the Euler angles that
         * correspond to the supplied quaternion.
         */
        getEulerAngles: function (eulers) {
            var x, y, z, qx, qy, qz, qw, a2;

            eulers = (eulers === undefined) ? new pc2d.Vec3() : eulers;
            ...
            return eulers.set(x, y, z).scale(pc2d.math.RAD_TO_DEG);
        },

        /**
         * @function
         * @name pc2d.Quat#invert
         * @description Generates the inverse of the specified quaternion.
         * @returns {pc2d.Quat} Self for chaining.
         * @example
         * // Create a quaternion rotated 180 degrees around the y-axis
         * var rot = new pc2d.Quat().setFromEulerAngles(0, 180, 0);
         *
         * // Invert in place
         * rot.invert();
         */
         ...
         * @param {pc2d.Quat} rhs - The quaternion used as the second multiplicand of the operation.
         * @returns {pc2d.Quat} Self for chaining.
         * @example
         * var a = new pc2d.Quat().setFromEulerAngles(0, 30, 0);
         * var b = new pc2d.Quat().setFromEulerAngles(0, 60, 0);
         *
         ...
         * @name pc2d.Quat#mul2
         * @description Returns the result of multiplying the specified quaternions together.
         * @param {pc2d.Quat} lhs - The quaternion used as the first multiplicand of the operation.
         * @param {pc2d.Quat} rhs - The quaternion used as the second multiplicand of the operation.
         * @returns {pc2d.Quat} Self for chaining.
         * @example
         * var a = new pc2d.Quat().setFromEulerAngles(0, 30, 0);
        ...
        /**
         * @function
         * @name pc2d.Quat#normalize
         * @description Returns the specified quaternion converted in place to a unit quaternion.
         * @returns {pc2d.Quat} The result of the normalization.
         * @example
         * var v = new pc2d.Quat(0, 0, 0, 5);
         *
         * v.normalize();
         *
        ...
        /**
         * @function
         * @name pc2d.Quat#setFromAxisAngle
         * @description Sets a quaternion from an angular rotation around an axis.
         * @param {pc2d.Vec3} axis - World space axis around which to rotate.
         * @param {number} angle - Angle to rotate around the given axis in degrees.
         * @returns {pc2d.Quat} Self for chaining.
         * @example
         * var q = new pc2d.Quat();
         * q.setFromAxisAngle(pc2d.Vec3.UP, 90);
         */
        setFromAxisAngle: function (axis, angle) {
            var sa, ca;

            angle *= 0.5 * pc2d.math.DEG_TO_RAD;
        ...
        /**
         * @function
         * @name pc2d.Quat#setFromEulerAngles
        ...
        setFromEulerAngles: function (ex, ey, ez) {
            ...
            halfToRad = 0.5 * pc2d.math.DEG_TO_RAD;
            ex *= halfToRad;
            ey *= halfToRad;
            ez *= halfToRad;
         ...
         * @param {pc2d.Mat4} m - The 4x4 matrix to convert.
         * @returns {pc2d.Quat} Self for chaining.
         * @example
         * // Create a 4x4 rotation matrix of 180 degrees around the y-axis
         * var rot = new pc2d.Mat4().setFromAxisAngle(pc2d.Vec3.UP, 180);
         *
         * // Convert to a quaternion
         * var q = new pc2d.Quat().setFromMat4(rot);
         */
         ...
         * @param {pc2d.Quat} lhs - The quaternion to interpolate from.
         * @param {pc2d.Quat} rhs - The quaternion to interpolate to.
         * @param {number} alpha - The value controlling the interpolation in relation to the two input
         * quaternions. The value is in the range 0 to 1, 0 generating q1, 1 generating q2 and anything
         * in between generating a spherical interpolation between the two.
         * @returns {pc2d.Quat} Self for chaining.
         * @example
         * var q1 = new pc2d.Quat(-0.11, -0.15, -0.46, 0.87);
         * var q2 = new pc2d.Quat(-0.21, -0.21, -0.67, 0.68);
         *
         * var result;
         * result = new pc2d.Quat().slerp(q1, q2, 0);   // Return q1
         * result = new pc2d.Quat().slerp(q1, q2, 0.5); // Return the midpoint interpolant
         * result = new pc2d.Quat().slerp(q1, q2, 1);   // Return q2
         */
        ...
        /**
         * @function
         * @name pc2d.Quat#transformVector
         * @description Transforms a 3-dimensional vector by the specified quaternion.
         * @param {pc2d.Vec3} vec - The 3-dimensional vector to be transformed.
         * @param {pc2d.Vec3} [res] - An optional 3-dimensional vector to receive the result of the transformation.
         * @returns {pc2d.Vec3} The input vector v transformed by the current instance.
         * @example
         * // Create a 3-dimensional vector
         * var v = new pc2d.Vec3(1, 2, 3);
         *
         * // Create a 4x4 rotation matrix
         * var q = new pc2d.Quat().setFromEulerAngles(10, 20, 30);
         *
