Object.assign(pc2d, (function () {
    ...
    Object.assign(Mat3.prototype, {
        /**
         * @function
         * @name pc2d.Mat3#clone
         * @description Creates a duplicate of the specified matrix.
         * @returns {pc2d.Mat3} A duplicate matrix.
         * @example
         * var src = new pc2d.Mat3().translate(10, 20, 30);
         * var dst = src.clone();
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"));
         */
        clone: function () {
            return new pc2d.Mat3().copy(this);
        },
         ...
         * @param {pc2d.Mat3} rhs - A 3x3 matrix to be copied.
         * @returns {pc2d.Mat3} Self for chaining.
         * @example
         * var src = new pc2d.Mat3().translate(10, 20, 30);
         * var dst = new pc2d.Mat3();
         * dst.copy(src);
         * console.log("The two matrices are " + (src.equals(dst) ? "equal" : "different"));
         */
        copy: function (rhs) {
        ...
        /**
         * @function
         * @name pc2d.Mat3#equals
         * @param {pc2d.Mat3} rhs - The other matrix.
         * @description Reports whether two matrices are equal.
         * @returns {boolean} True if the matrices are equal and false otherwise.
         * @example
         * var a = new pc2d.Mat3().translate(10, 20, 30);
         * var b = new pc2d.Mat3();
