Object.assign(pc2d, (function () {
    ...
    Object.assign(Mat4.prototype, {
        ...
        clone: function () {
            return new pc2d.Mat4().copy(this);
        },
        copy: function (rhs) {
            var src = rhs.data,
                dst = this.data;
        ...
        transformPoint: function (vec, res) {
            ...
            res = (res === undefined) ? new pc2d.Vec3() : res;
        ...
        transformVec4: function (vec, res) {
            ...
            res = (res === undefined) ? new pc2d.Vec4() : res;
        ...
        getTranslation: function (t) {
            t = (t === undefined) ? new pc2d.Vec3() : t;

            return t.set(this.data[12], this.data[13], this.data[14]);
        },

        getX: function (x) {
            x = (x === undefined) ? new pc2d.Vec3() : x;

            return x.set(this.data[0], this.data[1], this.data[2]);
        },

        getY: function (y) {
            y = (y === undefined) ? new pc2d.Vec3() : y;

            return y.set(this.data[4], this.data[5], this.data[6]);
        },

        getZ: function (z) {
            z = (z === undefined) ? new pc2d.Vec3() : z;
        ...
        getScale: (function () {
            ...
            return function (scale) {
                scale = (scale === undefined) ? new pc2d.Vec3() : scale;
        ...
        setFromEulerAngles: function (ex, ey, ez) {
            ...
            ex *= pc2d.math.DEG_TO_RAD;
            ey *= pc2d.math.DEG_TO_RAD;
            ez *= pc2d.math.DEG_TO_RAD;
